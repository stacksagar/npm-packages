...
export function Button2() {
  ...
  useEffect(() => {
    const isEnabled = localStorage.getItem("theme") === "dark" ? true : false;
        ...
        <div style={{ position: "relative" }}>
          ...
          <div
            style={{
              width: "40px",
              height: "16px",
              backgroundColor: "#9CA311",
              borderRadius: "9999px",
              boxShadow: "inset 0 2px 4px 0 #00000050",
            }}
          ></div>
          <div
            style={{
              ...
              top: "-0.25rem",
              transitionProperty:
                "color, background-color, border-color, textDecorationColor, fill, stroke, opacity, box-shadow, transform, filter,backdropFilter",
              transitionTimingFunction: "cubic-bezier(0.4, 0, 0.2, 1)",
              transitionDuration: "150ms",
              transform: `${enabled ? "translateX(100%)" : ""}`,
            }}
          ></div>
        </div>
      </label>
...
export default function ToggleButton({ style }: toggleButtonProps) {
  if (style === "C") return <Button3 />;
  else if (style === "B") return <Button2 />;
  else return <Button1 />;
}
